...
*/
	...
	if ( $sidebar_id ) {
		...
		if ( isset($arr_sidebars_widgets[$sidebar_id]) && is_array($arr_sidebars_widgets[$sidebar_id]) && !empty($arr_sidebars_widgets[$sidebar_id]) ) {
			...
			$info .= count($arr_sidebars_widgets[$sidebar_id][1])." widgets ready for processing (sidebars_widgets)<br />";
			...
			$info .= count($cs_sidebars[$sidebar_id][1])." widgets ready for processing (cs_sidebars)<br />";
		} else {
