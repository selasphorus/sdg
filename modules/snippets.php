...
// TODO/WIP: for old custom-sidebar widgets, reverse all the logic for general use -- e.g. sermons sidebar cs-29
// WIP 231214
function reverse_snippet_logic () {
	...
	$info .= '<div class="code">';
	$info .= ">> reverse_snippet_logic for snippet_id: $snippet_id<br />";
