...
function sdg_clean_unwanted_caps() {
	...
	$delete_caps = array(
        ...
        'edit_ensembles', 'edit_others_ensembles', 'edit_private_ensembles', 'delete_ensembles', 'delete_published_ensembles', 'delete_others_ensembles', 'delete_private_ensembles', 'publish_ensembles', 'read_private_ensembles',
        'edit_lectionary', 'edit_private_lectionary', 'edit_others_lectionary', 'delete_lectionary', 'delete_published_lectionary', 'delete_others_lectionary', 'delete_private_lectionary', 'publish_lectionary', 'read_private_lectionary',
        'edit_lectionarys', 'edit_private_lectionarys', 'edit_others_lectionarys', 'delete_lectionarys', 'delete_published_lectionarys', 'delete_others_lectionarys', 'delete_private_lectionarys', 'publish_lectionarys', 'read_private_lectionarys',
        'edit_lectionary_days', 'edit_private_lectionary_days', 'edit_others_lectionary_days', 'delete_lectionary_days', 'delete_published_lectionary_days', 'delete_others_lectionary_days', 'delete_private_lectionary_days', 'publish_lectionary_days', 'read_private_lectionary_days',
        'edit_music', 'edit_private_music', 'edit_others_music', 'delete_music', 'delete_published_music', 'delete_others_music', 'delete_private_music', 'publish_music', 'read_private_music',
        'edit_musics', 'edit_private_musics', 'edit_others_musics', 'delete_musics', 'delete_published_musics', 'delete_others_musics', 'delete_private_musics', 'publish_musics', 'read_private_musics',
        //'edit_dinosaurs', 'edit_private_dinosaurs', 'edit_others_dinosaurs', 'delete_dinosaurs', 'delete_published_dinosaurs', 'delete_others_dinosaurs', 'delete_private_dinosaurs', 'publish_dinosaurs', 'read_private_dinosaurs',
